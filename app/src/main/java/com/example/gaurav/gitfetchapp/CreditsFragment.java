...
public class CreditsFragment extends Fragment {
    ...
    @BindView(R.id.credits_app_name)
    TextView credits_app_name_Text;
    View rootView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Typeface tf_1 = Typeface.createFromAsset(getContext().getResources().getAssets(),"font/RobotoCondensed-Bold.ttf");
        credits_app_name_Text.setTypeface(tf_1);
